...
const WhatsAppButton = () => {
  ...
  return (
    <motion.a
      ...
      whileTap={{ scale: 0.9 }}
      className="fixed bottom-6 right-6 sm:bottom-8 sm:right-8 z-50 touch-manipulation group"
    ...
    >
      ...
      <div className="relative">
        ...
        <div className="relative bg-green-500 hover:bg-green-600 text-white p-4 sm:p-4 rounded-full shadow-2xl transition-all duration-300 group-hover:shadow-green-500/50">
          {/* WhatsApp Icon SVG */}
          <svg
            viewBox="0 0 24 24"
